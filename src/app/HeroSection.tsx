...
export default function HeroSection() {
    return (
        <section className="relative min-h-screen overflow-hidden bg-gradient-to-r from-[#1306AA] to-[#2d4391]">
            ...
            <div className="relative z-10 mx-auto flex max-w-7xl items-center gap-20 px-16 py-12">
                <div className="relative flex-1">
                    <div className="flex justify-between w-5/6">
                        ...
                        <div className="absolute right-32 bottom-32 h-8 w-8 rounded-full border-4 border-orange-400 border-b-transparent rotate-60" />
                    </div>
                    <h1 className="my-8 text-3xl w-96 font-bold leading-tight text-blue-400">
                        Sell with the fastest-growing and preferred acquisition channel
                    </h1>

                    <div className="mb-12 flex items-center gap-6">
                        <button className="rounded-full bg-gradient-to-l from-orange-400 via-orange-400 to-red-400 py-2 px-8 font-bold text-white transition hover:bg-red-600">
                            SIGN UP
                        </button>
                ...
                <div className="relative flex-1 h-96">
                    ...
                    <div className="absolute top-6 right-72 h-[220px] w-[320px]">
                        <div className="relative z-10 h-[220px] w-[320px]">
                            <Image
                                src="/mask1.png"
                                alt="Billboard mask"
                                fill
                        ...
                        <div className="absolute -bottom-9 left-20 h-[200px] w-[236px] rounded-b-[100px] bg-yellow-400" />
                    </div>
                    ...
                    <div className="absolute top-32 right-0 h-[190px] w-[280px]">
                        <div className="relative z-10 h-[190px] w-[280px]">
                            <Image
                                src="/mask2.png"
                                alt="Billboard mask"
                                fill
                        ...
                        <div className="absolute -bottom-2 right-11 h-[150px] w-[200px] rounded-br-[60px] bg-cyan-400" />
                    </div>

                    <div className="absolute -right-8 top-0 h-10 w-10 rounded-full border-4 border-orange-400 border-b-transparent -rotate-60" />


                    <div className="absolute right-32 -bottom-24 z-10 text-center">
